...
#ifndef CPU_RISCV32_VM_MACROASSEMBLER_RISCV32_HPP
#define CPU_RISCV32_VM_MACROASSEMBLER_RISCV32_HPP
...
#define verify_klass_ptr(reg) _verify_method_ptr(reg, "broken klass " #reg, __FILE__, __LINE__)
 ...
 public:
  // enum used for riscv32--x86 linkage to define return type of x86 function
...
private:
  ...
  // Return true if an addres is within the 48-bit Riscv32 address
  // space.
...
#endif // CPU_RISCV32_VM_MACROASSEMBLER_RISCV32_HPP
